                        ...
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolLabel: Record<string, { pending: string; done: string }> = {
                              str_replace_editor: {
                                pending: fileName ? `Editing ${fileName}…` : "Editing file…",
                                done: fileName ? `Edited ${fileName}` : "File edited",
                              },
                              file_manager: {
                                pending: "Updating files…",
                                done: "Files updated",
                              },
                            };
                            const label = toolLabel[tool.toolName] ?? { pending: tool.toolName, done: tool.toolName };
                            return (
